 ...
 */
export const getConsoleAccentColor = (_mode: ConsoleMode = 'playstation', opacity: number = 1): string => {
  const colors = {
 ...
 */
export const getConsoleAccentColorHex = (_mode: ConsoleMode = 'playstation'): string => {
  switch (_mode) {
    case 'playstation':
