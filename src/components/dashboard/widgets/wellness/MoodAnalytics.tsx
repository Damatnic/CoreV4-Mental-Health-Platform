      ...
      <div className="bg-white rounded-lg p-4">
        ...
        {viewMode === 'correlations' && (
          <div className="space-y-4">
            ...
            $match = import { useState, _useEffect, useMemo } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import {
  TrendingUp,
  TrendingDown,
      ...
      <div className="bg-white rounded-lg p-4">
        ...
        {viewMode === 'predictions' && (
          <div className="space-y-4">
            ...
            return import { useState, _useEffect, useMemo } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import {
  TrendingUp,
  TrendingDown,
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg p-4">
        ...
        {viewMode === 'predictions' && (
         ...
         { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); () => onTriggerIdentified?.(trigger.trigger)(e); } }} role="button" tabIndex={0}> onTriggerIdentified?.(trigger.trigger)}
                    >
                      <div className="flex items-center space-x-3">
                        <AlertCircle className="h-4 w-4 text-orange-500" />
                        <span className="text-sm font-medium text-gray-800">{trigger.trigger}</span>
