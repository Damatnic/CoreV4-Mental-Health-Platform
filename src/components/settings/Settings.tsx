              ...
              <div className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" aria-label="Dark Mode" className="sr-only peer" />
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
              ...
              <div className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" aria-label="Share data for research" className="sr-only peer" />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" aria-label="Analytics & Usage Data" className="sr-only peer" />
